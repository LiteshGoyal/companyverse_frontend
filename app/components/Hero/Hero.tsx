          ...
          <div className="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 gap-x-16">
            <div className={` transition-all duration-700 ease-out
              ...
              <p className="mt-4 text-lg font-normal text-gray-400 sm:mt-8">
                 Connecting companies with skilled professionals, developers, managers, and industry experts through one intelligent platform designed to simplify hiring, collaboration, networking, and long-term business growth for modern organizations.
