                ...
                <div className="max-w-lg mx-auto text-center md:max-w-2xl">
                    ...
                    <form action="#" method="POST" className="relative mt-8 rounded-full sm:mt-12">
                        ...
                        <div className="sm:absolute flex sm:right-1.5 sm:inset-y-1.5 mt-4 sm:mt-0">
                            <Link href="/dashboard" className="inline-flex items-center justify-center w-full px-5 py-5 text-sm font-semibold tracking-widest text-black uppercase transition-all duration-200 bg-white rounded-full sm:w-auto sm:py-3 hover:opacity-90">GET STARTED</Link>
                        </div>
                    </form>
